            ...
            var noticias = new List<Noticias>{
             ...
             "O caso remonta ainda ao período em que Xanoca representava o HC Turquel, tendo assinado pelo SC Tomar no início da presente temporada, na qual acabou por disputar 28 jogos e apontar cinco golos. Entretanto, o jogador tem já acordo para continuar a representar os nabantinos na época quem", Data=new DateTime(2018,05,05), Fotografia="Noticia4.jpg", UtilizadorPK=2, ListaDeEquipas = new List<Equipas>{equipas[6]},IsVisible=true},
                ...
                "«Sinto que estou a crescer de dia para dia. Os métodos de trabalho aqui são muito bons, o que faz com que os jogadores evoluam muito. A nível de campeonato sinto que estou a fazer uma boa época, tenho ajudado sempre a equipa e vou continuar a fazê-lo até ao final», finalizou o jogador que tem também como objetivo tentar conquistar a Taça de Portugal, uma vez que a AD Valongo ainda está em prova, tendo encontro marcado com o SC Tomar nas meias-finais.", Data=new DateTime(2018,05,18), Fotografia="Noticia5.jpg", UtilizadorPK=2, ListaDeEquipas = new List<Equipas>{equipas[10]},IsVisible=true },
                 ...
                 "Benfica e FC Porto estão empatados no segundo lugar, a um ponto do Sporting", Data=new DateTime(2018,04,22), Fotografia="Noticia6.jpg", UtilizadorPK=2, ListaDeEquipas = new List<Equipas>{equipas[10], equipas[1] },IsVisible=true },
                 ...
                 "O FC Porto confirmou o estatuto de clube mais vitorioso na prova, ao somar 17 troféus, mais dois do que o Benfica.", Data=new DateTime(2018,06,17), Fotografia="Noticia7.jpg", UtilizadorPK=2, ListaDeEquipas = new List<Equipas>{equipas[3] },IsVisible=true },
                 ...
                 "O Valongo, que se apurou pela primeira vez para a final, vai discutir o troféu com o FC Porto, vencedor das duas últimas edições.", Data=new DateTime(2018,06,16), Fotografia="Noticia8.jpg", UtilizadorPK=2, ListaDeEquipas = new List<Equipas>{equipas[5] },IsVisible=true },
                   ...
                   "Depois dos títulos de voleibol e andebol, leões sagram-se campeões nacionais de hóquei em patins. Recorde-se que o Sporting regressou à modalidade em 2012.", Data=new DateTime(2018,06,2), Fotografia="Noticia9.jpg", UtilizadorPK=2, ListaDeEquipas = new List<Equipas>{equipas[2], equipas[3]},IsVisible=true },
                   ...
                   "Assim, estará às ordens de Vítor Pereira, que será o treinador da equipa da Caravela na próxima temporada. ", Data=new DateTime(2018,07,11), Fotografia="Noticia11.jpg", UtilizadorPK=2, ListaDeEquipas = new List<Equipas>{equipas[13]},IsVisible=true },
                   ...
                   "Com este triunfo, o Sporting aumentou a vantagem na liderança do campeonato. Tem quatro pontos de avanço sobre FC Porto e Benfica.", Data=new DateTime(2018,05,28), Fotografia="Noticia10.jpg", UtilizadorPK=2, ListaDeEquipas = new List<Equipas>{equipas[2]},IsVisible=true },
