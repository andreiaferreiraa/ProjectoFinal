    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            var noticias = new List<Noticias>{
                ...
                "O jogo entre FC Porto e Sporting está agendado para as 12h30, enquanto que três horas depois há lugar para o Barcelona x Reus, jogo para o qual ainda existem bilhetes disponíveis. Para domingo, às 12h30, está agendada a final da competição.", Fotografia="Noticia1.jpg", Data=new DateTime(2018,05,09), ListaDeEquipas = new List<Equipas>{equipas[1], equipas[2]}},
                ...
                "Na próxima jornada, o Benfica continua com o calendário difícil: o jogo é no Dragão Caixa, daqui a duas semanas. Já a Oliveirense recebe o Turquel.", Data=new DateTime(2018,05,07), Fotografia="Noticia2.jpg", ListaDeEquipas = new List<Equipas>{equipas[0], equipas[2]}},
