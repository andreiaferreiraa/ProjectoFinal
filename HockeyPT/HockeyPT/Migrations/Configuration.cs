namespace HockeyPT.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<HockeyPT.Models.HockeyBD>
    {
        ...
        protected override void Seed(HockeyPT.Models.HockeyBD context)
        {
            //*****************************************************************************************************************
            // adiciona Equipas
            ...
            var jogadores = new List<Jogadores> {
               ...
               new Jogadores {ID=23, Nome="João Lima", Posicao="Defesa/Médio", DataNascimento=new DateTime(1990,03,10), Nacionalidade="Espanha", Altura=1.86, Peso=87.4, Fotografia="CarlesGrau.jpg", EquipaPK=3   },
              ...
              new Jogadores {ID=39, Nome="João Souto", Posicao="Avançado", DataNascimento=new DateTime(1992,07,26), Nacionalidade="Portugal", Altura=1.78, Peso=75.7, Fotografia="JoaoSouto.jpg", EquipaPK=4  },
               ...
               new Jogadores {ID=48, Nome="Gonçalo Neto", Posicao="Avançado", DataNascimento=new DateTime(1988,02,05), Nacionalidade="Portugal" , Altura=1.73, Peso=81.1, Fotografia="PabloCancela.jpg", EquipaPK=5  },
               ...
               new Jogadores {ID=57, Nome="Gustavo Lima", Posicao="Avançado", DataNascimento=new DateTime(1993,11,13), Nacionalidade="Portugal", Altura=1.72,Peso=69.6, Fotografia="GustavoSilva.jpg", EquipaPK=6  },
               ...
               new Jogadores {ID=62, Nome="Diogo Alves", Posicao="Guarda Redes", DataNascimento=new DateTime(1997,02,04), Nacionalidade="Portugal", Altura=1.78, Peso=79.1, Fotografia="DiogoAlvez.jpg", EquipaPK=7  },
               ...
               new Jogadores {ID=75, Nome="Afonso Lima", Posicao="Defesa/Médio", DataNascimento=new DateTime(1985,04,27), Nacionalidade="Portugal", Altura=1.84, Peso=78, Fotografia="AfonfoLima.jpg", EquipaPK=8 },
            ...
            var noticias = new List<Noticias>{
                new Noticias {ID=1, Titulo="FC Porto x Sporting com lotação esgotada", Conteudo="Menos de duas horas. Foi o tempo que bastou para os bilhetes da meia final da Liga Europeia, entre FC Porto e Sporting, esgotarem no Dragão Caixa.Segundo anunciou o FC Porto, os ingressos que foram colocados à venda na manhã desta quarta-feira estão já completamente esgotados, para aquele que será o primeiro jogo da final four da Liga Europeia que o Dragão Caixa organizará.O jogo entre FC Porto e Sporting está agendado para as 12h30, enquanto que três horas depois há lugar para o Barcelona x Reus, jogo para o qual ainda existem bilhetes disponíveis. Para domingo, às 12h30, está agendada a final da competição.", Fotografia="Noticia1.jpg", ListaDeEquipas = new List<Equipas>{equipas[1], equipas[2]}},
                new Noticias {ID=2, Titulo="Benfica cola-se ao FC Porto na liderança", Conteudo="Num final de semana marcado pelo empate do Sporting em Barcelos (2x2), o Benfica terminou com a jornada 22 com um triunfo, em casa, por 5x2, perante a Oliveirense, colando-se ao FC Porto na liderança do campeonato.A vitória começou a desenhar-se logo na primeira parte, com uma metade inicial demolidora dos encarnados. Um hattrick de João Rodrigues e um golo de Diogo Rafael levaram o Benfica a vencer por 4x0 para o intervalo. Na segunda parte, a Oliveirense ainda encurtou a vantagem encarnada para 4x2, por Ricardo Barreiros e Nuno Araújo, aproveitando o desperdício encarnado, que falhara dois penáltis e um livre direto até então. Até final, destaque para o fechar de contas por Diogo Rafael.Na próxima jornada, o Benfica continua com o calendário difícil: o jogo é no Dragão Caixa, daqui a duas semanas. Já a Oliveirense recebe o Turquel.", Fotografia="Noticia2.jpg", ListaDeEquipas = new List<Equipas>{equipas[0], equipas[2]}},
                new Noticias {ID=3, Titulo="Sporting escorrega em Barcelos e complica contas do título", Conteudo="O Sporting não passou no Municipal de Barcelos! Num dos jogos grandes da 22ª jornada da 1ª Divisão, os leões não foram além de um empate (2x2) frente ao Óquei Clube de Barcelos, podendo terminar a ronda na terceira posição.Os visitantes entraram melhor no jogo, chegando ao primeiro golo logo aos quatro minutos, por Vítor Hugo. O conjunto da casa reagiu e conseguiu a igualdade por Juanjo, aos 11´.No segundo tempo, o Sporting voltou a entrar melhor, voltando a conseguir mexer no marcador, com o segundo tento de Vítor Hugo. A quatro minutos do final, o conjunto orientado por Paulo Pereira restabeleceu o empate por Marinho, com a divisão de pontos a verificar-se no final.", Fotografia="Noticia3.jpg", ListaDeEquipas = new List<Equipas>{equipas[1], equipas[7]}},
             ...
             "Mas o caso é insólito. O castigo de um ano de suspensão foi dado como iniciado a 30 de junho de 2017, mas só esta sexta-feira é que foi dado a conhecer, o que significa que Xanoca esteve a jogar durante o periodo em que era suposto estar castigado.Desta forma, uma vez que o castigo apenas foi anunciado esta sexta-feira, Xanoca vai cumprir apenas cerca de dois meses de suspensão, falhando as cinco jornadas finais do campeonato, mais a final-four da Taça de Portugal, na qual o SC Tomar tem encontro marcado com a AD Valongo nas meias-finais.O caso remonta à temporada passada, em que Xanoca é acusado de em três momentos distintos – quarto trimestre de 2016 e primeiro e terceiro de trimestres de 2017 - não ter comunicado a sua localização para um eventual controlo antidopagem, algo obrigatório para os jogadores que estão em via de poderem representar as seleções nacionais.No entanto, Xanoca terá enviado a informação acerca da sua localização para o Conselho Nacional Antidopagem mas em ficheiros não aceites pela autoridade de antidopagem, o que na prática levou à imposição do castigo de um ano sem competição devido a «negligência». Uma suspensão proposta pelo Conselho Nacional Antidopagem e acatada pelo Conselho de Disciplina da Federação de Patinagem de Portugal, embora a federação tenha proposto apenas uma advertência ao jogador.O caso remonta ainda ao período em que Xanoca representava o HC Turquel, tendo assinado pelo SC Tomar no início da presente temporada, na qual acabou por disputar 28 jogos e apontar cinco golos. Entretanto, o jogador tem já acordo para continuar a representar os nabantinos na época quem", Fotografia="Noticia4.jpg", ListaDeEquipas = new List<Equipas>{equipas[6]}},
                new Noticias {ID=5, Titulo="Guilherme Silva: «Lutaremos pelo 5.º lugar até final»", Conteudo="São 32 os pontos que separam a AD Valongo do Grândola, quinto e último classificados, respetivamente. As duas equipas medem forças este sábado, em partida referente à 22.ª jornada do campeonato, e Guilherme Silva, hoquista dos valonguenses, aponta à conquista dos três pontos para o objetivo de segurar o quinto lugar ficar mais perto.«Em casa somos uma equipa muito forte, estamos na reta final do campeonato e queremos acabá-lo da melhor maneira», afirmou Guilherme Silva, em declarações ao zerozero.pt.«Pensamos jogo a jogo e em conquistar os três pontos. O nosso objetivo é o quinto lugar e vamos lutar por ele até final», acrescentou o avançado valonguense, que garantiu que esta forma de pensar vai ser posta em prática diante do Grândola.«O Grândola é uma equipa que está a lutar pela manutenção e sabemos que vai dar tudo para a conseguir. No jogo da primeira volta criou-nos dificuldades, mas estamos a preparar-nos bem para conquistar os três pontos».Autor de nove golos esta época, sete no campeonato e dois na Taça de Portugal, Guilherme Silva, que cumpre a segunda temporada na AD Valongo, está satisfeito com o trabalho que a equipa tem vindo a fazer e diz sentir-se a evoluir a nível pessoal.«Sinto que estou a crescer de dia para dia. Os métodos de trabalho aqui são muito bons, o que faz com que os jogadores evoluam muito. A nível de campeonato sinto que estou a fazer uma boa época, tenho ajudado sempre a equipa e vou continuar a fazê-lo até ao final», finalizou o jogador que tem também como objetivo tentar conquistar a Taça de Portugal, uma vez que a AD Valongo ainda está em prova, tendo encontro marcado com o SC Tomar nas meias-finais.", Fotografia="Noticia5.jpg",ListaDeEquipas = new List<Equipas>{equipas[10]}},
                new Noticias {ID=6, Titulo="Celso Silva: «É uma final para o Infante Sagres e para o HC Braga»", Conteudo="No penúltimo lugar com dez pontos, a seis da zona de salvação quando faltam apenas cinco jornadas para o término do campeonato, apenas a vitória interessa ao Infante Sagres na deslocação ao reduto do HC Braga, adversário direto na luta pela permanência, uma vez que a equipa minhota é antepenúltima apenas com mais um ponto que a portuense.O Infante Sagres vem de uma derrota em casa frente à AD Valongo, mas tem a esperança de conseguir um bom resultado como equipa visitante, tendo como exemplo o último jogo que realizou fora de portas, no qual venceu o Valença por 4x5.«É uma final tanto para nós como para o HC Braga», admitiu Celso Silva, em declarações ao zerozero.pt. «Nenhuma das equipas pode, nem quer perder este jogo. Temos que ganhar para conseguir atingir os nossos objetivos», acrescentou o hoquista do Infante Sagres, que atira a pressão para o lado dos minhotos.«Acho que é um jogo em que qualquer resultado pode acontecer e o HC Braga por ter o fator casa penso que tem mais pressão sobre si. No nosso caso, até temos feito melhores exibições fora do nosso pavilhão», disse, garantindo que a lição sobre o adversário está estudada.«Sabemos o que temos de fazer. O HC Braga gosta de partir o jogo e jogar rápido. Nós temos de conseguir esses contra-ataques se queremos conseguir um resultado positivo. Temos que ter uma união muito forte, dar tudo dentro da pista e temos que querer ganhar o jogo mais que o nosso adversário. Acima de tudo, temos que ter uma mentalidade muito forte porque acho que a equipa que perder a cabeça primeiro vai sair derrotada», finalizou Celso Silva.", Fotografia="Noticia6.jpg", ListaDeEquipas = new List<Equipas>{equipas[11], equipas[12]}},
            };
